...
class State(str, Enum):
    ...
    WF1_ASK_LANGUAGE = "WF1_ASK_LANGUAGE"
    WF1_ASK_PROMPT = "WF1_ASK_PROMPT"
    WF1_GENERATING_SCRIPT = "WF1_GENERATING_SCRIPT"
    WF1_CONTINUING = "WF1_CONTINUING"
    ...
    WF3_ASK_LANGUAGE = "WF3_ASK_LANGUAGE"
    WF3_ASK_WORDCOUNT = "WF3_ASK_WORDCOUNT"
    WF3_PROCESSING = "WF3_PROCESSING"
    WF3_CONTINUING = "WF3_CONTINUING"
    ...
    WF4_ASK_LANGUAGE = "WF4_ASK_LANGUAGE"
    WF4_ASK_WORDCOUNT = "WF4_ASK_WORDCOUNT"
    WF4_MODIFYING = "WF4_MODIFYING"
    WF4_CONTINUING = "WF4_CONTINUING"
    WF4_UPLOADING = "WF4_UPLOADING"
    WF4_ASK_STYLE = "WF4_ASK_STYLE"
    WF4_ASK_CHARACTER = "WF4_ASK_CHARACTER"
    WF4_ASK_BACKGROUND = "WF4_ASK_BACKGROUND"
    WF4_ASK_CONSISTENCY = "WF4_ASK_CONSISTENCY"
    WF4_GENERATING_PROMPTS = "WF4_GENERATING_PROMPTS"
    WF4_COMPLETE = "WF4_COMPLETE"
    # Workflow 5: Image + Audio Slideshow
    WF5_AWAITING_FILES = "WF5_AWAITING_FILES"
    WF5_PROCESSING = "WF5_PROCESSING"
    WF5_UPLOADING = "WF5_UPLOADING"
    WF5_COMPLETE = "WF5_COMPLETE"
    # Workflow 6: Script to Voice
    WF6_AWAITING_SCRIPT = "WF6_AWAITING_SCRIPT"
    WF6_ASK_VOICE = "WF6_ASK_VOICE"
    WF6_ASK_STYLE = "WF6_ASK_STYLE"
    WF6_PROCESSING = "WF6_PROCESSING"
    WF6_COMPLETE = "WF6_COMPLETE"
